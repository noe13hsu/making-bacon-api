...
category_education = Category.create!(user_id: noe.id, description: "education", category_type: 1)
category_gaming = Category.create!(user_id: noe.id, description: "gaming", category_type: 1)
...
Transaction.create!(category_id: category_food.id, description: "food", amount: "4.5", date: "2021-05-06")
Transaction.create!(category_id: category_food.id, description: "milk", amount: "3.5", date: "2021-04-06")
Transaction.create!(category_id: category_food.id, description: "pizza", amount: "10.5", date: "2021-05-13")
Transaction.create!(category_id: category_food.id, description: "food", amount: "4.5", date: "2021-05-06")
Transaction.create!(category_id: category_food.id, description: "milk", amount: "3.5", date: "2021-04-06")
Transaction.create!(category_id: category_food.id, description: "pizza", amount: "10.5", date: "2021-07-13")

Transaction.create!(category_id: category_gifts.id, description: "flower", amount: "20", date: "2021-07-21")
Transaction.create!(category_id: category_gifts.id, description: "flower", amount: "20", date: "2021-06-21")
Transaction.create!(category_id: category_gifts.id, description: "flower", amount: "20", date: "2021-05-21")

Transaction.create!(category_id: category_education.id, description: "book", amount: "50", date: "2021-06-21")
Transaction.create!(category_id: category_education.id, description: "book", amount: "40", date: "2021-07-21")
Transaction.create!(category_id: category_education.id, description: "book", amount: "20", date: "2021-07-21")
Transaction.create!(category_id: category_education.id, description: "book", amount: "20", date: "2021-06-21")

Transaction.create!(category_id: category_gaming.id, description: "game", amount: "70", date: "2021-07-21")
Transaction.create!(category_id: category_gaming.id, description: "game", amount: "70", date: "2021-06-21")
Transaction.create!(category_id: category_gaming.id, description: "game", amount: "70", date: "2021-07-21")
Transaction.create!(category_id: category_gaming.id, description: "game", amount: "70", date: "2021-06-21")


Transaction.create!(category_id: category_transportation.id, description: "train", amount: "4.5", date: "2021-07-02")
Transaction.create!(category_id: category_transportation.id, description: "train", amount: "4.5", date: "2021-05-02")
Transaction.create!(category_id: category_transportation.id, description: "train", amount: "4.5", date: "2021-06-02")
Transaction.create!(category_id: category_transportation.id, description: "train", amount: "4.5", date: "2021-06-02")
Transaction.create!(category_id: category_transportation.id, description: "train", amount: "4.5", date: "2021-05-02")
Transaction.create!(category_id: category_transportation.id, description: "train", amount: "4.5", date: "2021-07-02")
